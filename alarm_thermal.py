...
pygame.mixer.init()
sound_path = "C:/Users/Daryl Guerzon/Desktop/try sound/try sound.mp3"  # Path to your sound file
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if retThermal:
                ...
                if 0 <= thermalX < thermalImage.shape[1] and 0 <= thermalY < thermalImage.shape[0]:
                    ...
                    # Play sound if temperature is 35°C or above
                    if faceTemperature >= 35.0:
                        chicken_sound.play()  # Play sound when temperature is high
                else:
        ...
        for idx, (face, isolated) in enumerate(zip(faces, isolatedFlags)):
            ...
            if isolated:
                ...
                # Play sound if a face is isolated
                chicken_sound.play()  # Play sound when isolation is detected
